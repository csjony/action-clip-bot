...
SPEC: list[dict] = [
    ...
    {"group": "Video plan", "desc": "Target shape of a full video.", "fields": [
        ...
        {"key": "video.sfx.provider", "label": "SFX provider", "type": "select", "default": "freesound",
         "options": ["freesound", "elevenlabs", "mmaudio", "foley"],
         "help": "foley = free self-hosted V2A on the GPU (CC-BY-NC: non-commercial only)."},
    ...
    {"group": "Music & SFX network", "desc": "API timeouts, retries and paging.", "fields": [
        ...
        {"key": "sfx_api.replicate_create_retries", "label": "Replicate create retries", "type": "int", "default": 5, "min": 1, "max": 10,
         "help": "Retries on 429 throttle (Retry-After honored)."},        {"key": "sfx_api.replicate_version", "label": "MMAudio version pin", "type": "text",
         "default": "62871fb59889b2d7c13777f08deb3b36bdff88f7e1d53a50ad7694548a41b484"},
    ]},
    {"group": "Self-hosted Foley", "desc": "Free V2A on the GPU server (non-commercial license).", "fields": [
        {"key": "foley.variant", "label": "Checkpoint", "type": "select", "default": "small_16k",
         "options": ["small_16k", "small_44k", "medium_44k", "large_44k"]},
